...
TEXTURE DATA
id: HullID, WeaponID, or ProjectileID (whichever applies) from the hull/weapon/projectile file.
type: 'ship', 'turret', 'turretbarrel', 'turretunder', 'hardpoint', 'hardpointbarrel', 'hardpointunder', or 'missile'.
